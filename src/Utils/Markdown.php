...
use Kiwilan\Steward\Utils\Markdown\MarkdownFileUpload;
use Kiwilan\Steward\Utils\Markdown\MarkdownFrontmatter;
...
class Markdown
{
    ...
    private function parseImages(): array
    {
        ...
        foreach ($images as $image) {
            $item = MarkdownFileUpload::make()->upload($image, $this->options->imagesPath());
