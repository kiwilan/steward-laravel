...
class ZiggyTypeService
{
    ...
    private function generate(): string
    {
        ...
        $content .= '  }' . PHP_EOL;
        $content .= '  url?: string;' . PHP_EOL;
        $content .= '  version?: string;' . PHP_EOL;
        $content .= '  scrollRegions?: { top: number; left: number; }[];' . PHP_EOL;
        $content .= '  rememberedState?: Record<string, unknown>;' . PHP_EOL;
        $content .= '  resolvedErrors?: import("@inertiajs/core").Errors;' . PHP_EOL;
        $content .= '}' . PHP_EOL . PHP_EOL;

        $content .= 'declare global {' . PHP_EOL;
        $content .= '  declare interface ZiggyLaravelRoutes extends LaravelRoutes {}' . PHP_EOL;
        $content .= '  declare interface InertiaPage extends IPage {}' . PHP_EOL;
        $content .= '}' . PHP_EOL;
        ...
        $content .= '    sessions: { agent: { is_desktop: boolean; browser: string; platform: string; }, ip_address: string; is_current_device: boolean; last_active: string; }[];' . PHP_EOL;
        $content .= '  }' . PHP_EOL;
        $content .= '}' . PHP_EOL;
